...
#     La media de las diferencias de los tiempos entre los diferentes grupos son iguales
# Ha: Sí existen diferencias en el tiempo que tardan los usuarios en formular
#     consultas para problemas con diferente nivel de dificultad en
#     el área de psicología.
#     La media de las diferencias de los tiempos entre los diferentes grupos son distintas.
